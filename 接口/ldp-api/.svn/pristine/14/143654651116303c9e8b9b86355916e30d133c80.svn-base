...
public class StorageEnterDetailDto implements Serializable{
	private static final long serialVersionUID = 1L;
	//private Long enterDetailId;
	/** 临时批号*/
	private String entryactTempBillbatch;
	
	private int dataFlag;
	private String billtypeCode;
	private String enterBillcode;

	private String enterBillbatch;

	private String memberCode;

	private String enterLeadBillbatch;

	private String enterDetailOptcode;

	private String enterDetailOptbatch;

	private String enterDetailBilltype;
	...
	private Long enterDetailState;

	private String enterDetailRemark;
	...
	private Double enterDetailOknum;

	private Double enterDetailOkweight;

	private Double enterDetailOkassistweight;

	private Double enterDetailNum;

	private Double enterDetailWeight;

	private Double enterDetailAssistweight;
	...
	public String getEnterBillbatch() {
		return enterBillbatch;
	}

	public void setEnterBillbatch(String enterBillbatch) {
		this.enterBillbatch = enterBillbatch;
	}
	...
	public String getEnterDetailOptcode() {
		return enterDetailOptcode;
	}

	public void setEnterDetailOptcode(String enterDetailOptcode) {
		this.enterDetailOptcode = enterDetailOptcode;
	}

	public String getEnterDetailOptbatch() {
		return enterDetailOptbatch;
	}

	public void setEnterDetailOptbatch(String enterDetailOptbatch) {
		this.enterDetailOptbatch = enterDetailOptbatch;
	}

	public String getEnterDetailBilltype() {
		return enterDetailBilltype;
	}

	public void setEnterDetailBilltype(String enterDetailBilltype) {
		this.enterDetailBilltype = enterDetailBilltype;
	}
	...
	public Long getEnterDetailState() {
		return enterDetailState;
	}

	public void setEnterDetailState(Long enterDetailState) {
		this.enterDetailState = enterDetailState;
	}

	public String getEnterDetailRemark() {
		return enterDetailRemark;
	}

	public void setEnterDetailRemark(String enterDetailRemark) {
		this.enterDetailRemark = enterDetailRemark;
	}
	...
	public Double getEnterDetailOknum() {
		return enterDetailOknum;
	}

	public void setEnterDetailOknum(Double enterDetailOknum) {
		this.enterDetailOknum = enterDetailOknum;
	}

	public Double getEnterDetailOkweight() {
		return enterDetailOkweight;
	}

	public void setEnterDetailOkweight(Double enterDetailOkweight) {
		this.enterDetailOkweight = enterDetailOkweight;
	}

	public Double getEnterDetailOkassistweight() {
		return enterDetailOkassistweight;
	}

	public void setEnterDetailOkassistweight(Double enterDetailOkassistweight) {
		this.enterDetailOkassistweight = enterDetailOkassistweight;
	}

	public Double getEnterDetailNum() {
		return enterDetailNum;
	}

	public void setEnterDetailNum(Double enterDetailNum) {
		this.enterDetailNum = enterDetailNum;
	}

	public Double getEnterDetailWeight() {
		return enterDetailWeight;
	}

	public void setEnterDetailWeight(Double enterDetailWeight) {
		this.enterDetailWeight = enterDetailWeight;
	}

	public Double getEnterDetailAssistweight() {
		return enterDetailAssistweight;
	}

	public void setEnterDetailAssistweight(Double enterDetailAssistweight) {
		this.enterDetailAssistweight = enterDetailAssistweight;
	}
	...
	public String getEntryactTempBillbatch() {
		return entryactTempBillbatch;
	}

	public void setEntryactTempBillbatch(String entryactTempBillbatch) {
		this.entryactTempBillbatch = entryactTempBillbatch;
	}
